...
def parse_opts():
    ...
    parser.add_argument('--end_epoch', default=15, type=int, help='Training ends at this epoch.')
    # parser.add_argument('--resume_path', default=r'F:\Projects\YOWO-master\backup\yowo_tennis_8f_checkpoint.pth', type=str, help='Continue training from pretrained (.pth)')
